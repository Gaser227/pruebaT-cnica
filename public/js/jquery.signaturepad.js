...
(function ($) {
  ...
  function SignaturePad(selector, options) {
    ...
    function startDrawing(e, touchObject) {
      if (document.getElementById("error")) {
        ...
        document.getElementById("areaFirma").removeChild(error);
      }
      if (touchable) {
    ...
    function onFormError(errors, context, settings) {
      if (errors.nameInvalid) {
        context.prepend(['<p id="', settings.errorClass, '">', settings.errorMessage, '</p>'].join(''))
      ...
      if (errors.drawInvalid)
        context.prepend(['<p id="', settings.errorClass, '">', settings.errorMessageDraw, '</p>'].join(''))
    }
  ...
  $.fn.signaturePad.defaults = {
    ...
    , errorMessageDraw: 'Por favor realice su firma' // The error message displayed when drawOnly and no signature is drawn
